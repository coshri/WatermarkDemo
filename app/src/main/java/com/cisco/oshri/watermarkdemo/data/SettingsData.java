...
public class SettingsData {
    ...
    static {
        ...
        setValue(UPLOAD_URL, "http://192.168.1.100:8083/content?name=");
    ...
    public static ColorDrawable getUserColor() {
        ...
        switch (user.toUpperCase()) {
            case "YELLOW":
                return new ColorDrawable(0xFFD2E045);

            case "BLUE":
                return new ColorDrawable(0xFF00BCEB);

            case "PINK":
                return new ColorDrawable(0xFFE045C6);
